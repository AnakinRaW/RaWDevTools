...
internal abstract class GameVerificationStep(CreateGameDatabaseStep createDatabaseStep, GameRepository repository, IServiceProvider serviceProvider)
    : PipelineStep(serviceProvider)
{
    ...
    protected GameRepository Repository => repository;
